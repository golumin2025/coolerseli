import { g as getActionQueryString, f as astroCalledServerError, A as ActionError, d as deserializeActionResult, e as ACTION_QUERY_PARAMS, h as appendForwardSlash, u as unflatten } from './index_CZ0Thlii.mjs';
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, i as escape, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderComponent } from './astro/server_CHAIO-ej.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CL3JRhnm.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DsgrhaEZ.mjs').then(n => n._);
