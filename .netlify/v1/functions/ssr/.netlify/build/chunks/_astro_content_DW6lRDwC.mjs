import { g as getActionQueryString, f as astroCalledServerError, A as ActionError, d as deserializeActionResult, e as ACTION_QUERY_PARAMS, h as appendForwardSlash, u as unflatten } from './index_4TMrCK_I.mjs';
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_BxwiW2A6.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D18BbhBL.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_TURNSTILE_SITE_KEY": "1x00000000000000000000AA", "SITE": undefined, "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BXg0V4QM.mjs').then(n => n._);
